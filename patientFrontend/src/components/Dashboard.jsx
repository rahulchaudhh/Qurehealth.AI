      ...
      <header className="bg-white px-10 py-4 flex justify-between items-center border-b border-gray-200 shadow-sm sticky top-0 z-50">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4 relative">
            ...
            >
              <img
                src={user.profilePicture || `https://ui-avatars.com/api/?name=${encodeURIComponent(user.name)}&background=3b82f6&color=fff&size=128`}
                alt="Profile"
                className="w-10 h-10 rounded-full object-cover border-2 border-blue-100 shadow-sm"
                referrerPolicy="no-referrer"
                onError={(e) => { e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(user.name)}&background=3b82f6&color=fff&size=128`; }}
              />
              ...
              <div className="absolute right-0 top-14 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 z-50 overflow-hidden">
                ...
                <div className="flex items-center gap-4 p-5 pb-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-sm text-gray-500 truncate">@{user.name.replace(/\s+/g, '')}</p>
                  </div>
                </div>
                ...
                <div className="px-3 py-3 space-y-1">
                  <button
                    onClick={() => { navigate('/patient/profile'); setShowProfileDropdown(false); }}
                  ...
                  <button
                    onClick={() => { setCurrentPage('appointments'); setShowProfileDropdown(false); }}
                    className="w-full text-left px-4 py-3 text-sm font-semibold text-blue-600 hover:bg-blue-50 rounded-xl transition-colors flex items-center gap-3"
                  >
                  ...
                  <button
                    onClick={() => { setCurrentPage('medical-history'); setShowProfileDropdown(false); }}
                    className="w-full text-left px-4 py-3 text-sm font-semibold text-blue-600 hover:bg-blue-50 rounded-xl transition-colors flex items-center gap-3"
                  >
